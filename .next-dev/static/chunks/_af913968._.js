...
function StitchProductCard(param) {
    let { product, explanation, imageOverride } = param;
    _s();
...
function SearchExperience(param) {
    ...
    const resultImage = (slug, productId)=>cutoutSlugs.has(slug) ? "/generated-product-views/".concat(slug, "/official-front.png?v=3") : requestedRed && slug === "mr-260" ? "/musterring-catalog/mr-260/image-08-hq.jpg" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$musterring$2d$assets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productImages"])(productId)[0];
