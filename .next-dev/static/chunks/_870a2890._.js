...
"[project]/lib/fit-simulator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const EPSILON = 0.001;
function calculateScale(roomWidth, roomLength, viewportWidth, viewportHeight) {
    let padding = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 64;
...
function collidesWithDoorSwing(roomWidth, roomLength, placement, width, depth, door) {
    ...
    return corners.some((point)=>Math.hypot(point.x - hinge.x, point.y - hinge.y) <= door.width) || edges.some((param)=>{
        let [a, b] = param;
        return distanceToSegment(hinge, a, b) <= door.width;
    });
}
function buildComponents(product) {
    let removedParts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
    const moduleCount = product.modular ? Math.max(2, Math.min(4, product.numberOfSeats || 3)) : 1;
    const components = Array.from({
        length: moduleCount
    }, (_, index)=>({
            id: "".concat(product.id, "-module-").concat(index + 1),
            name: moduleCount === 1 ? "Assembled product" : "Module ".concat(index + 1),
...
function evaluateDelivery(components, input) {
    ...
    const passages = [
        ...
        return {
            ...
            message: passage.available <= 0 ? "Measurement missing" : heightConflict ? "Height may be insufficient" : delta < 0 ? "".concat(Math.ceil(Math.abs(delta) / 10), " cm more width may be needed") : "".concat(Math.floor(delta / 10), " cm spare width")
        };
    });
    if (input.elevatorWidth || input.elevatorDepth || input.elevatorHeight) {
        ...
        const fits = orientations.some((param)=>{
            let [width, depth, height] = param;
            return width <= input.elevatorWidth && depth <= input.elevatorDepth && height <= input.elevatorHeight;
        });
        passages.push({
            id: "elevator",
            name: "Elevator",
...
function analyzePlacement(roomWidth, roomLength, product, placement, items, doors) {
    ...
    for (const item of items){
        if (collidesWithItem(placement, product.widthMm, product.depthMm, item)) {
            issues.push({
                ...
                severity: "conflict",
                message: "".concat(item.name, " overlaps the product footprint.")
            });
        }
    }
    ...
    if (frontClearance < 600) issues.push({
        ...
        message: "".concat(Math.max(0, Math.round(frontClearance / 10)), " cm walking clearance remains in front.")
    });
...
"[project]/components/FitCheckerClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/fit-simulator.ts [app-client] (ecmascript)");
;
...
function DimensionInput(param) {
    let { label, value, onChange, min = 0, help } = param;
    _s();
    const [draft, setDraft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(String(cm(value)));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DimensionInput.useEffect": ()=>setDraft(String(cm(value)))
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                children: [
                    label,
                    help && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                        title: help,
                        children: "?"
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        "aria-label": "".concat(label, " in centimetres"),
                        type: "number",
                        min: min / 10,
                        value: draft,
                        onChange: (event)=>{
...
_s(DimensionInput, "WMjV65dJS1h0ngcE/0hp7n3Bjs0=");
_c = DimensionInput;
function StatusMark(param) {
    let { status } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: "fit-status fit-status-".concat(status),
        children: [
...
_c1 = StatusMark;
function FitCheckerClient(param) {
    let { product } = param;
    _s1();
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "FitCheckerClient.useState": ()=>initialState(product)
    }["FitCheckerClient.useState"]);
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("room");
    ...
    const [deliveryProgress, setDeliveryProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(18);
    ...
    const pinchDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const components = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FitCheckerClient.useMemo[components]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildComponents"])(product, state.removedParts)
    }["FitCheckerClient.useMemo[components]"], [
        product,
        state.removedParts
    ]);
    const roomAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FitCheckerClient.useMemo[roomAnalysis]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzePlacement"])(state.room.width, state.room.length, product, state.placement, state.items, state.doors)
    }["FitCheckerClient.useMemo[roomAnalysis]"], [
        state,
        product
    ]);
    const deliveryAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FitCheckerClient.useMemo[deliveryAnalysis]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateDelivery"])(components, state.delivery)
    }["FitCheckerClient.useMemo[deliveryAnalysis]"], [
        components,
        state.delivery
    ]);
    const suggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FitCheckerClient.useMemo[suggestions]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["suggestPlacements"])(state.room.width, state.room.length, product, state.items, state.doors)
    }["FitCheckerClient.useMemo[suggestions]"], [
        state.room,
        state.items,
        state.doors,
        product
    ...
    const measurementMissing = Object.entries(state.delivery).filter((param)=>{
        let [, value] = param;
        return value <= 0;
    }).map((param)=>{
        let [name] = param;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FitCheckerClient.useEffect": ()=>{
            const draft = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].fitDraft(product.id);
            if (draft === null || draft === void 0 ? void 0 : draft.state) setState(draft.state);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FitCheckerClient.useEffect": ()=>{
            ...
            const timeout = window.setTimeout({
                "FitCheckerClient.useEffect.timeout": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].saveFitDraft(product.id, {
                        state,
                        step,
                        updatedAt: new Date().toISOString()
                    })
            }["FitCheckerClient.useEffect.timeout"], 350);
            return ({
                "FitCheckerClient.useEffect": ()=>window.clearTimeout(timeout)
            })["FitCheckerClient.useEffect"];
        }
    }["FitCheckerClient.useEffect"], [
        product.id,
    ...
    const rotate = (amount)=>commit((current)=>({
                ...
                placement: {
                    ...current.placement,
                    rotation: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeRotation"])(current.placement.rotation + amount)
                }
            }));
    ...
    const addItem = (kind)=>{
        const id = "".concat(kind, "-").concat(Date.now());
        commit((current)=>({
                ...current,
                items: [
                    ...current.items,
    ...
    const saveReport = ()=>{
        const id = "fit-".concat(product.id, "-").concat(Date.now());
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].saveFitReport({
            id,
    ...
    const downloadReport = ()=>{
        ...
        anchor.href = url;
        anchor.download = "".concat(product.modelCode.replace(/\s/g, "-"), "-fit-report.json");
        anchor.click();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: STEPS.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    "furniture",
                                                    "restricted"
                                                ].map((kind)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: state.items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("details", {
                                        ...
                                        children: [
                                            ...
                                            [
                                                ...
                                                "armrests",
                                                "backrests"
                                            ].map((part)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "fit-check",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            type: "checkbox",
                            ...
                            activeTab === "room" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                        ...
                                        viewBox: "".concat(pan.x, " ").concat(pan.y, " ").concat(roomViewWidth, " ").concat(roomViewHeight),
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("title", {
                                                id: "fit-room-title",
                                                children: "Top-down room placement for ".concat(product.modelCode)
                                            }, void 0, false, {
                                                fileName: "[project]/components/FitCheckerClient.tsx",
                                                lineNumber: 271,
                                                columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("desc", {
                                                id: "fit-room-desc",
                                                children: "".concat(state.room.width / 1000, " by ").concat(state.room.length / 1000, " metre room. Placement status is ").concat(roomAnalysis.status, ".")
                                            }, void 0, false, {
                                                fileName: "[project]/components/FitCheckerClient.tsx",
                                                lineNumber: 272,
                                                columnNumber: 15
                                            ...
                                            state.items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                                                    className: "fit-svg-item is-".concat(item.kind, " ").concat(selectedItem === item.id ? "is-selected" : ""),
                                                    onPointerDown: (event)=>{
                                            ...
                                            state.doors.map((door)=>{
                                                const hinge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fit$2d$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doorHingePoint"])(door, state.room.width, state.room.length);
                                                const vertical = door.wall === "east" || door.wall === "west";
                                                const lineStart = door.position;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                                                    className: "fit-door",
                                                    children: [
                                                        vertical ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                                            ...
                                                            lineNumber: 284,
                                                            columnNumber: 31
                                                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                                            x1: lineStart,
                                                        ...
                                                        door.opens === "inward" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("circle", {
                                                            cx: hinge.x,
                                                            cy: hinge.y,
                                                            r: door.width
                                                        }, void 0, false, {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                                                className: "fit-product-shape fit-status-".concat(roomAnalysis.status),
                                                transform: "translate(".concat(state.placement.x, " ").concat(state.placement.y, ") rotate(").concat(state.placement.rotation, ")"),
                                                onPointerDown: (event)=>{
                                                    event.currentTarget.setPointerCapture(event.pointerId);
                                                    setDragging("product");
                                                },
                                                children: [
                                                    ...
                                                    }, (_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("rect", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                                ...
                                                transform: "rotate(90 ".concat(state.room.width - 80, " ").concat(state.room.length / 2, ")"),
                                                textAnchor: "middle",
                                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        "aria-live": "polite",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusMark, {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "fit-route",
                                        children: [
                                            deliveryAnalysis.passages.map((passage, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "fit-route-segment fit-status-".concat(passage.status),
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            children: index + 1
                                                        }, void 0, false, {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                                                            children: passage.available ? "".concat(cm(passage.available), " cm") : "Not measured"
                                                        }, void 0, false, {
                                                            fileName: "[project]/components/FitCheckerClient.tsx",
                                                            lineNumber: 301,
                                                            columnNumber: 194
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            components.map((component)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {}, void 0, false, {
                                                            fileName: "[project]/components/FitCheckerClient.tsx",
                                                            lineNumber: 305,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: suggestions.map((suggestion, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            }, "".concat(suggestion.placement.x, "-").concat(suggestion.placement.y), true, {
                                                fileName: "[project]/components/FitCheckerClient.tsx",
                                                lineNumber: 313,
                                                columnNumber: 172
                                            }, this))
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                children: [
                                    ...
                                    roomAnalysis.issues.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        children: roomAnalysis.issues.map((issue)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                                                        size: 15
                                                    }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        children: deliveryAnalysis.passages.map((passage)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatusMark, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: measurementMissing.length ? "".concat(measurementMissing.length, " optional elevator measurement").concat(measurementMissing.length === 1 ? " is" : "s are", " missing. Add them if elevator transport is required.") : "All requested route measurements are available."
                                    }, void 0, false, {
                                        fileName: "[project]/components/FitCheckerClient.tsx",
                                        lineNumber: 322,
                                        columnNumber: 48
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: "/handover?product=".concat(product.id, "&subject=fit-report"),
                                        children: [
...
_s1(FitCheckerClient, "HbBPTA0tZ35ulRxdaBKMUUBu9l0=");
_c2 = FitCheckerClient;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "DimensionInput");
__turbopack_context__.k.register(_c1, "StatusMark");
__turbopack_context__.k.register(_c2, "FitCheckerClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_870a2890._.js.map