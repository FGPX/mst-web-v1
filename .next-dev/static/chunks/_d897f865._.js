...
"[project]/lib/comparison.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/CompareClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/persistence.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$comparison$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/comparison.ts [app-client] (ecmascript)");
...
;
;
function CompareClient(param) {
    let { initialIds } = param;
    _s();
    const activeProducts = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].filter((product)=>product.active && product.category !== "storage");
    const [ids, setIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialIds.length ? initialIds.slice(0, 3) : activeProducts.slice(0, 3).map({
        "CompareClient.useState": (p)=>p.id
    }["CompareClient.useState"]));
    const [diffOnly, setDiffOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [saved, setSaved] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const selected = activeProducts.filter((product)=>ids.includes(product.id));
    const awards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$comparison$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["comparisonAwards"])(selected);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompareClient.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].track({
    ...
    const rows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompareClient.useMemo[rows]": ()=>[
                [
                    "Width",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(Math.round(p.widthMm / 10), " cm")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Depth",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(Math.round(p.depthMm / 10), " cm")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Height",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(Math.round(p.heightMm / 10), " cm")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Seat Height",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(Math.round(p.seatHeightMm / 10), " cm")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Seat Depth",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(Math.round(p.seatDepthMm / 10), " cm")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Seats",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>String(p.numberOfSeats)
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Modularity",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>p.modular ? "Modular system" : "Fixed composition"
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Functions",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>[
                                ...p.functions,
                                ...p.electricFunctions
                ...
                [
                    "Materials",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>"".concat(p.materials.length, " curated cover families")
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Comfort",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>p.comfortOptions.join(", ") || "Retailer consultation"
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Armrests",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>p.armrestOptions.join(", ") || "Configuration dependent"
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Feet",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>p.feetOptions.join(", ") || "Configuration dependent"
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Configurator",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>p.category === "storage" ? "Retailer planning" : "Available"
                    }["CompareClient.useMemo[rows]"])
                ],
                [
                    "Overall dimensions",
                    selected.map({
                        "CompareClient.useMemo[rows]": (p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dimensions"])(p.widthMm, p.depthMm, p.heightMm)
                    }["CompareClient.useMemo[rows]"])
                ]
            ].filter({
                "CompareClient.useMemo[rows]": (param)=>{
                    let [, values] = param;
                    return !diffOnly || new Set(values).size > 1;
                }
            }["CompareClient.useMemo[rows]"])
    }["CompareClient.useMemo[rows]"], [
        selected,
                ...
                children: [
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            "aria-label": "Remove ".concat(product.modelCode),
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    "aria-label": "".concat(product.modelCode, " highlights"),
                                                    children: (_awards_find = awards.find((award)=>award.productId === product.id)) === null || _awards_find === void 0 ? void 0 : _awards_find.labels.map((award)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            children: award
                                                        }, award, false, {
                                                            fileName: "[project]/components/CompareClient.tsx",
                                                            lineNumber: 67,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            onClick: ()=>{
                                                                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setComparison(ids);
                                                                setSaved(true);
                                                            },
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            selected.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                    children: product.modelCode
                                }, product.id, false, {
                                    fileName: "[project]/components/CompareClient.tsx",
                                    lineNumber: 78,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            selected.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: rows.map((param)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    values.map((value, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: value
                                        }, "".concat(name, "-").concat(index), false, {
                                            fileName: "[project]/components/CompareClient.tsx",
                                            lineNumber: 85,
                                            columnNumber: 96
                                        }, this))
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/handover",
                                onClick: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setComparison(ids),
                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: activeProducts.slice(0, 8).map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        type: "checkbox",
...
_s(CompareClient, "9heKFPqXXk/bVOTb9Ro6SQwlK8k=");
_c = CompareClient;
...
var _c;
__turbopack_context__.k.register(_c, "CompareClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_d897f865._.js.map