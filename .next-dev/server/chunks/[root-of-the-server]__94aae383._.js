module.exports = [
"[project]/.next-internal/server/app/api/ai/advisor/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/lib/ai/rate-limit.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function allowAssistantRequest(request, limit = 30, windowMs = 60_000) {
...
function productDiscoveryAnswer(question) {
    ...
    const sameCategory = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].filter((product)=>product.active && (!catalogueCategory || product.category === catalogueCategory));
...
function answerGroundedQuestion(question, context) {
    ...
    const simpleReply = /^(okay |ok )?(thanks|thank you|thank you very much|thanks a lot)$/.test(conversationalText) ? "You’re welcome! If you need anything else, I can help you find, compare or configure Musterring products." : /^(hi|hello|hey|good morning|good afternoon|good evening)$/.test(conversationalText) ? "Hello! How can I help with your Musterring furniture or project today?" : /^(ok|okay|alright|got it|understood|sounds good)$/.test(conversationalText) ? "Of course. Let me know what you’d like to explore next." : /^(bye|goodbye|see you|see you later)$/.test(conversationalText) ? "Goodbye! Your Musterring selections will be here when you return." : null;
    if (simpleReply) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$assistant$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["advisorAnswerSchema"].parse({
            answer: simpleReply,
            answerType: "fact",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v3/external.js [app-route] (ecmascript) <export * as z>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$assistant$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ai/assistant-schemas.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ai/rate-limit.ts [app-route] (ecmascript)");
...
const requestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    question: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(2).max(2000),
    context: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$assistant$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conversationContextSchema"]
});
async function POST(request) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowAssistantRequest"])(request).allowed) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Please wait before asking another question."
    }, {
        status: 429
    });
    const input = requestSchema.safeParse(await request.json().catch(()=>null));
    if (!input.success) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "The advisor question or context is invalid."
    }, {
        status: 400
    });
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$providers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withDemoFallback"])((provider)=>provider.answerProductQuestion(input.data));
    const activeProducts = new Map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].filter((product)=>product.active).map((product)=>[
            product.id,
            product
        ]));
    const validMaterials = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["materials"].map((material)=>material.id));
    const productIds = [
        ...new Set(result.data.productIds)
    ].filter((id)=>activeProducts.has(id));
    const materialIds = [
        ...new Set(result.data.materialIds)
    ].filter((id)=>validMaterials.has(id));
    const action = result.data.proposedAction;
    ...
    const invalidActionTarget = Boolean(actionProductId && !activeProducts.has(actionProductId) || actionSlug && !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].some((product)=>product.active && product.slug === actionSlug));
    ...
    const lostProductGrounding = result.data.productIds.length > 0 && productIds.length === 0;
    const answer = {
        ...result.data,
        answer: lostProductGrounding ? "The suggested product could not be verified in the connected Musterring catalogue, so it was not shown. Please refine the product request." : result.data.answer,
        answerType: lostProductGrounding ? "missing-data" : result.data.answerType,
        productIds,
        materialIds,
        proposedAction: invalidActionTarget || lostProductGrounding || !action ? null : {
            ...action,
            requiresConfirmation: action.requiresConfirmation || stateChanging.has(action.type)
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94aae383._.js.map