module.exports = [
"[project]/.next-internal/server/app/api/ai/room/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/ai/room/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["imageUploadSchema"].safeParse({
        type: file.type,
        size: file.size,
        consent
    }).success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Consent and a valid image are required."
        }, {
            status: 400
        });
    }
    const dataUrl = `data:${file.type};base64,${Buffer.from(await file.arrayBuffer()).toString("base64")}`;
    const analysis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$providers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withDemoFallback"])((provider)=>provider.analyzeRoomImage(dataUrl));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        analysis: analysis.data,
        ai: {
            provider: analysis.provider,
            fallback: analysis.fallback,
            mode: analysis.provider === "openai" ? "Provider-backed AI" : "Deterministic demo AI"
        }
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c07edaa6._.js.map