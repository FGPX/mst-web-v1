module.exports = [
"[project]/.next-internal/server/app/api/ai/search/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/lib/server-validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const cleanText = (maximum, minimum = 0)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(minimum).max(maximum).transform((value)=>value.replace(/[<>]/g, ""));
const handoverRequestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: cleanText(120, 1),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().email().max(254),
    phone: cleanText(40).optional().default(""),
    message: cleanText(2000).optional().default(""),
    requestType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        "Book a Consultation",
        "Request a Quote",
    ...
    projectData: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].record(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].unknown()).optional().default({})
});
const uploadMetadataSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v3/external.js [app-route] (ecmascript) <export * as z>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/server-validation.ts [app-route] (ecmascript)");
...
async function POST(request) {
    const rate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`ai-search:${request.headers.get("x-forwarded-for") ?? "local"}`, 20);
    if (!rate.allowed) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Too many AI search requests."
    }, {
        status: 429
    });
    ...
    if (!parsed.success) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Enter a valid search request."
    }, {
        status: 400
    });
    const simulateProviderError = ("TURBOPACK compile-time value", "development") !== "production" && request.headers.get("x-ai-test-provider-error") === "true";
    let firstAttempt = true;
    const interpreted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$providers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withDemoFallback"])((provider)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        closeAlternatives: results.closeAlternatives.map(({ product, reasons })=>({
                product,
                reasons
            })),
        ...
        ai: {
            ...
            mode: interpreted.provider === "openai" ? "Provider-backed AI" : "Deterministic demo AI"
        }
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__709d47ac._.js.map