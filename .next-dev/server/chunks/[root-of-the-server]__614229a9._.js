module.exports = [
"[project]/.next-internal/server/app/api/ai/alternatives/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/ai/alternatives/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["allowAssistantRequest"])(request).allowed) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Please wait before requesting more alternatives."
    }, {
        status: 429
    });
    const input = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$assistant$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["alternativeRequestSchema"].safeParse(await request.json().catch(()=>null));
    if (!input.success) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "The alternative request is incomplete.",
        details: input.error.flatten()
    }, {
        status: 400
    });
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$providers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withDemoFallback"])((provider)=>provider.findProductAlternatives(input.data));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__614229a9._.js.map