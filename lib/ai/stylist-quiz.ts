...
export const stylistQuizByRoom: Record<StylistRoomType, StylistQuizQuestion[]> = {
  "living-room": [
    ...
    { id: "special-functions", prompt: "Do you want any special functions?", maxSelections: 3, exclusiveOptions: ["none"], options: [option("relax-function", "Relax function"), option("recliner", "Recliner"), option("adjustable-headrest", "Adjustable headrest"), option("sofa-bed", "Sofa bed"), option("none", "No special functions")] },
  ...
  bedroom: [
    ...
    { id: "additional-storage", prompt: "Do you need additional storage?", maxSelections: 3, exclusiveOptions: ["no"], options: [option("under-bed", "Under-bed storage"), option("wardrobe", "Wardrobe storage"), option("dresser", "Dresser storage"), option("no", "No")] },
  ...
  hallway: [
    ...
    { id: "store-items", prompt: "What do you need to store?", maxSelections: 4, exclusiveOptions: ["everything"], options: [option("coats", "Coats"), option("shoes", "Shoes"), option("bags", "Bags"), option("accessories", "Accessories"), option("everything", "Everything")] },
  ...
  outdoor: [
    ...
    { id: "main-use", prompt: "How will you mainly use the space?", maxSelections: 3, exclusiveOptions: ["everything"], options: [option("relaxing", "Relaxing"), option("dining", "Dining"), option("entertaining", "Entertaining"), option("sunbathing", "Sunbathing"), option("everything", "Everything")] },
