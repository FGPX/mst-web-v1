...
export const stylistQuizByRoom: Record<StylistRoomType, StylistQuizQuestion[]> = {
  ...
  bathroom: [
    { id: "target", prompt: "What are you looking for in your bathroom?", help: "Choose one piece or a complete bathroom series.", options: [option("vanity-unit", "Vanity with useful storage"), option("tall-cabinet", "Tall storage cabinet"), option("mirror-cabinet", "Mirror cabinet"), option("complete-bathroom-series", "A complete coordinated bathroom")] },
    { id: "storage-amount", prompt: "How much storage do you need?", options: [option("minimal", "Just the daily essentials"), option("moderate", "Everyday storage for one or two"), option("lots", "Family-size storage")] },
    { id: "space", prompt: "How much wall space do you have?", help: "A rough estimate is fine, or enter exact dimensions if you know them.", dimensionOption: "dimensions", options: [option("compact", "Compact · under 80 cm"), option("medium", "Standard · 80–120 cm"), option("large", "Generous · over 120 cm"), option("dimensions", "Enter exact limits")] },
    { id: "mounting", prompt: "Do you prefer wall-mounted or floor-standing furniture?", appliesToTargets: ["vanity-unit", "tall-cabinet", "complete-bathroom-series"], options: [option("wall-mounted", "Light and open · wall-mounted"), option("floor-standing", "Grounded and classic · floor-standing"), option("no-preference", "Show me the best match")] },
    { id: "finish", prompt: "Which bathroom look do you prefer?", options: [option("light-wood", "Fresh light oak"), option("natural-tones", "Warm natural tones"), option("white", "Calm clean white"), option("dark-wood", "Rich dark wood"), option("dark-colours", "Modern dark contrast")] }
  ],
  hallway: [
